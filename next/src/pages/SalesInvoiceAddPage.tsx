...
export default function SalesInvoiceAddPage() {
    ...
    const customerOptions = useMemo(() => {
        if (!customers) return [];
        return customers.map((s) => ({ label: s.name, value: s.name }));
    }, [customers]);
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                                    ...
                                    <TableBody>
                                        {items.map((item, index) => (
                                            <TableRow key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                                <TableCell className="border-t border-gray-200 truncate">
                                                    <Combobox
                                                        options={itemOptions}
                        ...
                        <div className="flex justify-end pt-8">
                            <div className="text-right">
                                ...
                                <p className="text-xl font-bold text-gray-800">{currency} {numberFormatter.format(totalAmount)}</p>
                            </div>
                        </div>
                    </form>
                </CardContent>
